...
Fullstack developer. Oslo. Currently building an encrypted app nobody asked me to build.
...
2022. One year, full-time.

### Product Development — Malmö University
...
**Frontend.** Next.js, React, TypeScript, TailwindCSS **Backend.** Node.js, Supabase, Postgres, SanityCMS, PayloadCMS **Applied crypto.** AES-256-GCM, key hierarchies, zero-knowledge architecture **AI.** Claude API, prompt design, evals **Design.** Figma, Blender, Adobe Suite
